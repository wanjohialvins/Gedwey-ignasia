        ...
        <SafeAreaView className="flex-1">
          <View className="flex-1 px-4 pt-4 pb-6 justify-between">
            ...
            <View className="flex-1 justify-center gap-4 my-4">
              {[1, 2, 3, 4].map((i) => (
                <View key={i} className="bg-white/60 rounded-2xl p-4 flex-row items-center border border-neutral-border/10 shadow-sm">
    ...
    <ScreenShell className="flex-1">
      <SafeAreaView className="flex-1">
        <View className="flex-1 px-4 pt-4 pb-6 justify-between">
            ...
            {stages.map((stage) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  className={`bg-white/60 rounded-2xl p-3.5 flex-row items-center shadow-sm ${
          ...
          <View className="flex-row gap-3">
            <TouchableOpacity
              className="flex-1 h-12 bg-white/60 border border-slate-300 rounded-xl items-center justify-center active:bg-slate-50"
              onPress={() => router.back()}
